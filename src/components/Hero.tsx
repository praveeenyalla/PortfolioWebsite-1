        ...
        <div className="flex flex-col lg:flex-row items-center gap-12">
          ...
          <div className="lg:w-1/3 text-center lg:text-left">
            <div className="relative inline-block mb-6">
              <div className="w-64 h-64 bg-gradient-to-br from-blue-100 to-blue-200 rounded-full flex items-center justify-center mx-auto lg:mx-0 shadow-xl border-4 border-white">
            ...
            <div className="flex flex-col items-center lg:items-start space-y-2 mb-6">
              <div className="flex items-center text-gray-600">
                ...
                <span className="font-medium text-blue-600">yallanagapraveen.info</span>
              </div>
              <div className="flex items-center text-gray-600">
          ...
          <div className="lg:w-2/3 text-center lg:text-left">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-8">
              <div className="bg-white p-4 rounded-lg shadow-md border-l-4 border-blue-600">
                ...
                <p className="text-sm text-gray-600">3+ Years Development</p>
              </div>
              <div className="bg-white p-4 rounded-lg shadow-md border-l-4 border-green-600">
                <h3 className="font-semibold text-gray-900">Projects</h3>
                <p className="text-sm text-gray-600">15+ Completed</p>
              </div>
              <div className="bg-white p-4 rounded-lg shadow-md border-l-4 border-purple-600">
                ...
                <p className="text-sm text-gray-600">ExcelR Data Science</p>
              </div>
            </div>
            ...
            <div className="flex flex-col sm:flex-row gap-4 mb-8">
              ...
              <button
                ...
                className="border-2 border-blue-600 text-blue-600 hover:bg-blue-600 hover:text-white px-8 py-3 rounded-lg font-medium flex items-center justify-center gap-2 transition-all duration-200 transform hover:scale-105"
              >
              ...
              <button
                ...
                className="border-2 border-green-600 text-green-600 hover:bg-green-600 hover:text-white px-8 py-3 rounded-lg font-medium flex items-center justify-center gap-2 transition-all duration-200 transform hover:scale-105"
              >
